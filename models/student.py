...
class Student(nn.Module):
    def __init__(self, num_labels, model_cfg):
        ...
        self.encoder_layers = model_cfg.encoder_layers

        # Keep only 4 transformer blocks
        orig_layers = self.backbone.encoder.layer
        self.backbone.encoder.layer = nn.ModuleList(orig_layers[idx] for idx in self.encoder_layers)
